...
{!!mm&& <div style={{
  ...
  <h2 style={{marginRight: '15vw'}}>Finding Game</h2>
    ...
    <div style={{backgroundColor: '#F4F4F4', width: '100vw',height: '85vh',display:'flex'}}>
    ...
    <center style={{fontSize:'2vh',color:'black',marginTop:'0vh',width:'100%'}}>  <Alert severity="success">
  <AlertTitle><center style={{marginLeft:'32vw'}}>    Get in a group call, hear your friends try to pronounce the words!</center></AlertTitle></Alert>
</center>
